...
| 组件        | 描述                         | 示例                                                         |
| ----------- | ---------------------------- | ------------------------------------------------------------ |
| **CLAUDE.md** | 项目特定配置                 | 框架最佳实践、编码标准                                       |
| **Commands**  | 自定义斜杠命令               | /generate-tests, /check-file, /optimize-bundle               |
| **Agents**    | 领域 AI 专家                 | API 安全审计、React 性能、数据库优化                         |
| **MCPs**      | 外部服务集成                 | GitHub、数据库、开发工具                                     |
| **Analytics** | 实时监控仪表板               | 实时会话跟踪、使用统计、导出                                 |
