...
![Claude Code 模型训练](/images/builder-claude-code/image-1.png)
...
![直接模型访问](/images/builder-claude-code/image-2.png)
...
*本文基于 Builder.io 的 Steve Sewell 的原创作品。你可以在 [https://www.builder.io/blog/claude-code](https://www.builder.io/blog/claude-code) 找到原文。*
