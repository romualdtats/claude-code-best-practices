...
### [Preventing "You Are Right" Responses Hook](/docs/en/tools/you-are-not-right-hook)
**Author**: ljw1004  
**Type**: Claude Code Hook  
**Description**: An intelligent hook script that automatically detects and prevents Claude Code from using敷衍性回复, improving conversation quality and technical depth.

### [Claude Code Templates Collection](/docs/en/tools/claude-code-templates)
...
### [CUI Web UI](/docs/en/tools/cui-web-ui)
**Author**: Claude Code Community  
...
### Hooks and Scripts
- **Prevent敷衍性回复**: Intelligent hooks to improve conversation quality
