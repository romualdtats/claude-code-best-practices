...
_Looking for more detailed information? Our comprehensive documentation covers all the features mentioned in this post and provides additional examples, implementation details, and advanced techniques._
...
At Anthropic, we occasionally run `CLAUDE.md` files through a prompt improver and often tune instructions (e.g. adding emphasis with \"IMPORTANT\" or \"YOU MUST\") to improve adherence.
...
![Claude Code tool allowlist](/images/claude-code-tool-allowlist.png)
...
![Safe yolo mode](/images/safe-yolo-mode.png)
...
![Use Claude to interact with git](/images/claude-git-interaction.png)
...
![Give Claude images](/images/claude-give-images.png)

### c. Mention files you want Claude to look at or work on

![Mention files you want Claude to look at or work on](/images/claude-mention-files.png)
...
![Give Claude URLs](/images/claude-give-urls.png)
